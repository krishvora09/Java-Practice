...
//        NavigableSet<Contact> sorted = new TreeSet<>(phones);
        ...
        var headSetIncluded =
                fullSet.headSet(marion, true);
        headSetIncluded.forEach(System.out::println);
        System.out.println("-------------------------------------------------");

        var tailSetExcluded =
                fullSet.tailSet(marion, false);
        tailSetExcluded.forEach(System.out::println);
        System.out.println("-------------------------------------------------");
        ...
        var subsetOverLoaded =
                fullSet.subSet(linus, false,
                        marion, true);
        subsetOverLoaded.forEach(System.out::println);
    }
}
