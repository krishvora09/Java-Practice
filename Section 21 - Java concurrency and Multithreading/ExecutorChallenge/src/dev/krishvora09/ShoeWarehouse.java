...
public class ShoeWarehouse {
    ...
    private final ExecutorService fulfillmnetService;
    ...
    public ShoeWarehouse() {
        ...
        fulfillmnetService = Executors.newFixedThreadPool(3);
    }

    public void shutDown() {
        fulfillmnetService.shutdown();
    }
    ...
    public synchronized void receiveOrder(Order item) {
        ...
        fulfillmnetService.submit(this::fulfillOrder);
        notifyAll();
    }
