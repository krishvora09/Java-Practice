...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Consumer<String> printWordsLambda = (String sentence) -> {
            String[] parts = sentence.split(" ");
            for (String part : parts) {
                System.out.println(part);
            }
        ...
        Consumer<String> printWordsForEach = (String sentence) -> {
            String[] parts = sentence.split(" ");
        ...
        Consumer<String> printWordsConcise = (String sentence) -> {
            Arrays.asList(sentence.split(" ")).forEach(
