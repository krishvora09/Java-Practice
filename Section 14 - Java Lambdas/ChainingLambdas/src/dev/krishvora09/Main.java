...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Function<String, String> lastName = s -> s.concat(" Vora");
        Function<String, String> uCaseLastName = uCase.andThen(lastName);
        System.out.println(uCaseLastName.apply(name));

        Function<String, String> lastNameUCase = lastName.andThen(uCase);
        System.out.println(lastNameUCase.apply(name));

        uCaseLastName = uCase.compose(lastName);
        System.out.println(uCaseLastName.apply(name));

        Function<String, String[]> f0 = uCase
                .andThen(s -> s.concat(" Vora"))
                .andThen(s -> s.split(" "));
        ...
        Predicate<String> p1 = s -> s.equals("KRISH");
        Predicate<String> p2 = s -> s.equalsIgnoreCase("Krish");
